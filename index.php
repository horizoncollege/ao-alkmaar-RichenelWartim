...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="w-50 p-3 bg-info" style="height: 200px">
                    <h1>Richenel Wartim Dashboard</h1>
                    <h4>Hier Kunt u zien allen dingen die ik heb gemaakt tot nu toe. Voor vragen Kom naar me toe en stel ze </h4>
                </div>
            </div>
